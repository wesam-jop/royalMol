...
export default function ProductGrid() {
    ...
    const loadMoreProducts = () => setDisplayedProducts(prev => prev + 4);
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:p-8" dir="rtl">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">اكتشف أحدث منتجاتنا عالية الجودة بأسعار تنافسية مع خيارات دفع متعددة وتوصيل سريع</p>
                </div>
                {/* Products Grid (أحدث 8 منتجات) */}
                ...
                {/* زر عرض كل المنتجات بشكل عشوائي */}
                <div className="text-center">
                    <button 
                        onClick={() => { window.location.href = '/pageProduct'; }}
                        className="px-8 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors duration-300 shadow-md inline-flex items-center justify-center"
                    >
                        عرض كل المنتجات
                    </button>
                </div>
